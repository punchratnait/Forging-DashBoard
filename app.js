...
async function boot(){
  ...
  try{
    ...
    if(savedId){
      ...
      const blocked = user && ((PAGE_VIEW === 'dashboard' && !userHasDashboard) || (PAGE_VIEW === 'l1' && !userHasL1) || (PAGE_VIEW === 'supervisor' && !userHasSupervisorPage) || (PAGE_VIEW === 'heattreatment' && !userHasSupervisorPage) || (PAGE_VIEW === 'htentry' && !userHasSupervisorPage));
      if(user && !blocked){
