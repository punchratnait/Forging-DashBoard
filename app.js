  ...
  <div class="panel">
    <form id="entryForm">
      ...
      <div class="form-row">
        ...
        <div class="field"><label>Item</label><select id="f_item" required>${opts(itemsForMachine(d.machineId), d.itemId, 'Select item')}</select>
...
function attachNewEntryEvents(){
  ...
  locationSel.onchange = ()=>{
    ...
    itemSel.innerHTML = renderOptions(itemsForMachine(''), '', 'Select item');
    spmInput.value = '';
  };
  machineSel.onchange = ()=>{
    itemSel.innerHTML = renderOptions(itemsForMachine(machineSel.value), '', 'Select item');
    spmInput.value = '';
  };
