  ...
  <div class="panel">
    <form id="entryForm">
      ...
      <div class="form-row">
        ...
        <div class="field"><label>Weight Produced (g, optional)</label><input type="number" min="0" step="any" id="f_weight" value="${d.weight}">
