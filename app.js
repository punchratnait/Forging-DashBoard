    ...
    <form id="entryForm">
      ...
      <div class="form-row">
        ...
        <div class="field item-suggest-wrap"><label>Item</label>
          <input type="text" id="f_item_search" autocomplete="off" placeholder="Type 1+ characters to search item code or name..." value="${d.itemId && byId(DB.items,d.itemId) ? itemLabel(byId(DB.items,d.itemId)) : ''}">
