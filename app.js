...
function attachReportsEvents(){
  ...
  document.getElementById('exportCsv').onclick = ()=>{
    ...
    const header = ['Date','Shift','Site','Location','MachineCode','Machine','ItemCode','Item','ItemDescription','SPM','Weight','Qty','Rejected','DowntimeMin','Reason','Operator','Supervisor','OeePct','DowntimePct'];
