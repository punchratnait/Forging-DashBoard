...
let DB = { users:[], machines:[], items:[], spm:[], locations:[], sites:[], shifts:[], reasons:[], entries:[], invoices:[], plantmetrics:[], complaints:[], machineholds:[], htfurnaceitems:[], htreasons:[], htentries:[] };
...
const MD_TABS = [
  ...
  {key:'htfurnaceitems', label:'HT Item-Furnace Map'},
  {key:'htreasons', label:'HT Down Time Reasons'},
