...
function renderSummaryMatrix(){
  ...
  const colHeader = (p)=>{
    if(p.key === 'ytd') return `<th>${p.label}<div style="font-size:10px; font-weight:400; color:var(--ink-dim); margin-top:2px; text-transform:none; letter-spacing:normal;">(Data from 01-09-2026)</div></th>`;
