  ...
  <div class="panel">
    <form id="entryForm">
      ...
      <div class="form-row">
        ...
        <div class="field"><label>Supervisor</label><select id="f_supervisor" required>${renderOptions(DB.users.filter(u=>u.role==='supervisor'||u.role==='admin'), d.supervisorId, 'Select supervisor')}</select></div>
      </div>
