...
function htFurnaceItemEditor(){
  ...
  <div style="display:flex; align-items:flex-end; gap:16px; margin-bottom:16px; flex-wrap:wrap;">
    <div class="field" style="max-width:320px; margin-bottom:0;"><label>Search</label><input type="text" id="mdSearchInput" placeholder="Search by furnace or item code..." value="${mdSearch}"></div>
